...
int main()
{
    char PREDICTION_FILE_ADDRESSES[N_EXPERIMENTS][40];
    for(int i=0; i<N_EXPERIMENTS; i++)
    {
        char temp_address[40] = "";
        char temp_number[5] = "";
        snprintf(temp_number, sizeof(temp_number), "%d", i+1);
        strcat(temp_address, BASE_PREDICTION_ADDRESS);
        strcat(temp_address, "predictions_");
        strcat(temp_address, temp_number);
        strcat(temp_address, ".csv");
        strcpy(PREDICTION_FILE_ADDRESSES[i], temp_address);
    }
