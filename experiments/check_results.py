report_1 = open('cpp/exhaustive_search_1/results/1000_1/threshold_accuracy_report.txt', 'r')
...
report_2 = open('cpp/ilp/results/1000_1/threshold_accuracy_report.txt', 'r')
